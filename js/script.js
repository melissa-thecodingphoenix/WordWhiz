...
let wordList = [
    ...
    { 
        word: "freedom", 
        hint: "A fundamental right" 
    },
    { 
        word: "equality",
        hint: "Fairness and impartiality" 
    },
    { 
        word: "justice", 
        hint: "Fair treatment and judgment" 
    },
    { 
        word: "leadership", 
        hint: "Guidance or direction" 
    },
    {
        word: "football",
    ...
    { 
        word: "inspiration", 
        hint: "Stimulation of the mind" 
    },
    { 
        word: "perseverance", 
        hint: "Continued effort in spite of difficulties" 
    },
    { 
    ...
    { 
        word: "motivation", 
        hint: "Drive to do or achieve something" 
    },
    { 
        word: "ambition", 
        hint: "Desire or goal" 
    ...
    { 
        word: "selfesteem", 
        hint: "Self-respect or self-worth" 
    },
    { 
        word: "determination", 
    ...
    { 
        word: "community", 
        hint: "Group of people with shared interests" 
    },
    {
        word: "adventure",
    ...
    { 
        word: "resilience", 
        hint: "Ability to recover from or adjust easily to misfortune or change" 
    },
    {
        word: "novel",
...
const gameOver = (isVictory) => {
    ...
    setTimeout(() => {
        ...
        gameModal.querySelector("h4").innerText = `${isVictory ? 'Congratulations!' : 'You Got Hanged!'}`;
...
const initGame = (button, clickedLetter) => {
    ...
    // Calling gameOver function if any or these condition meets
